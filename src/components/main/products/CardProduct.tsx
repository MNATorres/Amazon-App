...
const data = {
  ...
  description: 'Aqui va la description Lorem ipsum, dolor sit amet consectetur adipisicing elit. Temporibus amet, ab eaque esse dolorum iure nisi facilis, consequatur ipsa explicabo modi maiores asperiores velit laboriosam suscipit, architecto quibusdam sit fugit?',
  price: 4.5,
  rating: 4.2,
  numReviews: 34,
};
